...
public class BaseParams {
    ...
    public final ConcurrentHashMap<String, List<FileWrapper>> fileArrayParams = new ConcurrentHashMap<String, List<FileWrapper>>();
    public final ConcurrentHashMap<String, Object> urlParamsWithObjects = new ConcurrentHashMap<String, Object>();


    public final ConcurrentHashMap<String, String> headParams = new ConcurrentHashMap<String, String>();
    ...
    public ArrayList keySign = new ArrayList();
    ...
    /**
     * Adds a String value to the head.
     *
     * @param key   the key name for the new param.
     * @param value the value int for the new param.
     */
    public void putHeadParams(String key, String value) {
        if (key != null) {
            headParams.put(key, String.valueOf(value));
        }
    }
